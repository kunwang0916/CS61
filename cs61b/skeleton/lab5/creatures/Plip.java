...
public class Plip extends Creature {
    ...
    private static final double moveEnergyCost = 0.15;
     ...
     */
    public void move() {
        energy = Math.max(minEnergy, energy - moveEnergyCost);
    }
     ...
     */
    public void stay() {
        energy = Math.min(maxEnergy, energy + stayEnergyGain) ;
    }

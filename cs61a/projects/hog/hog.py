"""CS 60A Presents The Game of Hog."""
...
def is_swap(player_score, opponent_score):
    ...
    return abs(player_tens - player_ones) == abs(opponent_tens - opponent_ones)
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            number_of_rolls = strategy0(score0, score1)
            score0 += take_turn(number_of_rolls, score1, dice)
        else:
            number_of_rolls = strategy1(score1, score0)
            score1 += take_turn(number_of_rolls, score0, dice)

...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        range = 0
        while p is not None:
            if len(p.bees) and p.exit is not None and (range >= self.min_range and range <= self.max_range):
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return self.contained_ant is None and other.is_container == False
        # END Problem 9
